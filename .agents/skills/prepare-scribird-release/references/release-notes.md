...
- 구현을 숨기지는 않되 사용자 영향으로 번역한다.
- 측정 수치는 실제 근거가 있을 때만 쓰고 단위와 조건을 보존한다.
...
사용자 노트:
마이크와 시스템 오디오를 공통 시간축의 재생 가능한 meeting.m4a 하나로 저장합니다.
```
...
**<짧은 결과 중심 제목>.** <기존 흐름이 어떻게 더 나아졌는지>.

## 고친 것

**<사용자가 겪던 증상>.** <이제 어떻게 동작하는지>. <필요하면 근거 수치나 복구 링크>.
